    ...
    methods: {
        data_start() {
            ...
            if (this.screenWidth < this.screenHeight) {
                if (this.screenWidth < 600) {
                    this.width_field = Math.floor(screenWidth * 0.8 / this.size) * this.size;
                }
            } else {
                if (this.screenHeight < 600) {
                    this.width_field = Math.floor(screenHeight * 0.8 / this.size) * this.size;
                }
            }
        },
        resize() {
        ...
        play() {
            ...
            if (audio.paused) {
                audio.volume = 0.2;
                audio.play();
                this.$refs.play.style.backgroundImage = 'url(./music-2-64.png)';
            } else {
                audio.pause();
                this.$refs.play.style.backgroundImage = 'linear-gradient(to bottom right, transparent 45%, cadetblue, transparent 52%), url(./music-2-64.png)';
            }
        },
        applause() {
